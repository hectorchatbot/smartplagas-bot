...
def get_timezone_location(
    ...
    Kanada (St. Johnâ€™s) (Ortszeit)
    >>> print(get_timezone_location(tz, locale='en'))
    Canada (St. Johnâ€™s) Time
...
def format_datetime(
    ...
    ...                 locale='fr_FR')
    'dimanche 1 avril 2007, 17:30:00 heure dâ€™Ã©tÃ© dâ€™Europe centrale'
...
def format_time(
    ...
    '15:30:00 heure dâ€™Ã©tÃ© dâ€™Europe centrale'
...
def get_period_id(
    ...
    :param type: The period type to use. Either "selection" or None.
                 ...
                 â€œYour email arrived yesterday eveningâ€ or â€œYour email arrived last nightâ€.
    :param locale: the `Locale` object, or a locale string. Defaults to the system time locale.
