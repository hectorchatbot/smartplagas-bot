...
class SigningRequestConfigurationInstance(InstanceResource):
    ...
    :ivar email_subject: Subject of the email that the end client will receive ex: â€œTwilio Hosting Requestâ€, maximum length of 255 characters.
    :ivar email_message: Content of the email that the end client will receive ex: â€œThis is a Hosting request from Twilio, please check the document and sign itâ€, maximum length of 5,000 characters.
