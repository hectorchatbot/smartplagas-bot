...
class ParticipantInstance(InstanceResource):
    ...
    :ivar last_read_message_index: Index of last â€œreadâ€ message in the [Conversation](https://www.twilio.com/docs/conversations/api/conversation-resource) for the Participant.
    :ivar last_read_timestamp: Timestamp of last â€œreadâ€ message in the [Conversation](https://www.twilio.com/docs/conversations/api/conversation-resource) for the Participant.
    """
    ...
    def update(
        ...
        :param last_read_message_index: Index of last â€œreadâ€ message in the [Conversation](https://www.twilio.com/docs/conversations/api/conversation-resource) for the Participant.
        :param last_read_timestamp: Timestamp of last â€œreadâ€ message in the [Conversation](https://www.twilio.com/docs/conversations/api/conversation-resource) for the Participant.
