...
class RecordingInstance(InstanceResource):
    ...
    :ivar status: 
    :ivar channels: The number of channels in the recording resource. For information on specifying the number of channels in the downloaded recording file, check out [Fetch a Recordingâ€™s media file](https://www.twilio.com/docs/voice/api/recording#download-dual-channel-media-file).
    :ivar source: 
