...
class BrandVettingInstance(InstanceResource):
    ...
    :ivar vetting_class: The type of vetting that has been conducted. One of â€œSTANDARDâ€ (Aegis) or â€œPOLITICALâ€ (Campaign Verify).
    :ivar vetting_status: The status of the import vetting attempt. One of â€œPENDING,â€ â€œSUCCESS,â€ or â€œFAILEDâ€.
