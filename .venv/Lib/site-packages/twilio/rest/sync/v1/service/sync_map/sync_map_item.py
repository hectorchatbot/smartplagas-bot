...
class SyncMapItemInstance(InstanceResource):
    ...
    def delete(self, if_match: Union[str, object] = values.unset) -> bool:
        ...
        :param if_match: If provided, applies this mutation if (and only if) the â€œrevisionâ€ field of this [map item] matches the provided value. This matches the semantics of (and is implemented with) the HTTP [If-Match header](https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/If-Match).
