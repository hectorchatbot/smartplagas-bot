...
maintainers = [
  ...
  {name = "John X. ÃƒÃ¸rÃ§eÄ", email = "john@utf8.org"},
  {name = "Î“Î±Î¼Î± ï­‡ æ±", email = "gama@utf8.org"},
]
classifiers = [
...
maintainers = [
  {name = "Ð¡Ñ‚ÐµÐ¿Ð°Ð½ Ð‘Ð°Ð½Ð´ÐµÑ€Ð°", email = "ÐºÑ€Ð¸Ñ—Ð²ÐºÐ°@Ð¾ÑƒÐ½-ÑƒÐ¿Ð°.ÑƒÐºÑ€"},
]
"""
...
@pytest.mark.parametrize(
    ...
    (
        pytest.param(
            PEP621_EXAMPLE,
            (
                'Brett Cannon <brett@python.org>, "John X. ÃƒÃ¸rÃ§eÄ" <john@utf8.org>, '
                'Î“Î±Î¼Î± ï­‡ æ± <gama@utf8.org>'
            ),
            id='non-international-emails',
        ),
        pytest.param(
            PEP621_INTERNATIONAL_EMAIL_EXAMPLE,
            'Ð¡Ñ‚ÐµÐ¿Ð°Ð½ Ð‘Ð°Ð½Ð´ÐµÑ€Ð° <ÐºÑ€Ð¸Ñ—Ð²ÐºÐ°@Ð¾ÑƒÐ½-ÑƒÐ¿Ð°.ÑƒÐºÑ€>',
...
class TestPyModules:
    ...
    @pytest.mark.parametrize("module", ["pip-run", "abc-d.Î»-xyz-e"])
