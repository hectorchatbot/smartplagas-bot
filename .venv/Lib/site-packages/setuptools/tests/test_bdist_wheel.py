...
EXAMPLES = {
    ...
    "unicode-dist": {
        ...
        "unicodedist": {"__init__.py": "", "Ã¥Ã¤Ã¶_æ—¥æœ¬èªž.py": ""},
    },
    "utf8-metadata-dist": {
        "setup.cfg": cleandoc(
            """
            ...
            version = 42
            author_email = "John X. ÃƒÃ¸rÃ§eÄ" <john@utf8.org>, Î“Î±Î¼Î± ï­‡ æ± <gama@utf8.org>
            long_description = file: README.rst
            """
        ),
        "README.rst": "UTF-8 æè¿° èª¬æ˜Ž",
    },
    "licenses-dist": {
        "setup.cfg": cleandoc(
            """
...
def test_unicode_record(wheel_paths):
    ...
    assert "Ã¥Ã¤Ã¶_æ—¥æœ¬èªž.py".encode() in record
...
Name: helloworld
Version: 42
Author-email: "John X. ÃƒÃ¸rÃ§eÄ" <john@utf8.org>, Î“Î±Î¼Î± ï­‡ æ± <gama@utf8.org>
...
def test_preserve_unicode_metadata(monkeypatch, tmp_path):
    ...
    assert 'Author-email: "John X. ÃƒÃ¸rÃ§eÄ"' in metadata
    assert "Î“Î±Î¼Î± ï­‡ æ± " in metadata
    assert "UTF-8 æè¿° èª¬æ˜Ž" in metadata
